...
// Component for displaying a single report
function ReportDiv({ rep, ind }) {
  ...
  // Function to fetch the job details by job ID
  const get_job = () => {
  ...
  // Function to handle editing the job
  const handleEdit = () => {
...
// Prop types for ReportDiv component
ReportDiv.propTypes = {
  rep: propTypes.shape({
    id: propTypes.string,
